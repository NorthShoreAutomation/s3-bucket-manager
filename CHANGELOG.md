...
### Fixed
- File download (`g`) in the S3 file browser now uses concurrent ranged GETs via `manager.Downloader` instead of a single streaming `GetObject`, improving speed and reliability on large files.
